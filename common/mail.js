...
var SITE_ROOT_URL = 'http://' + config.host + ':3000'; // todo 
...
exports.sendActiveMail = function (who, token, name) {
    ...
    var html = '<p>您好：' + name + '</p>' +
        ...
        '<a href  = "' + SITE_ROOT_URL + '/user/active_account?key=' + token + '&name=' + name + '">激活链接</a>' +
 ...
 * @param {String} name 接收人的用户名
 */
//http://localhost/active_account?key=7ba79288d685b79e641bc82951ba7cb4&name=008 todo 
exports.sendResetPassMail = function (who, token, name) {
    ...
    var html = '<p>您好：' + name + '</p>' +
        ...
        '<a href="' + SITE_ROOT_URL + '/user/reset_pass?key=' + token + '&name=' + name + '">重置密码链接</a>' +
        '<p>若您没有在' + config.name + '社区填写过注册信息，说明有人滥用了您的电子邮箱，请删除此邮件，我们对给您造成的打扰感到抱歉。</p>' +
        '<p>' + config.name + '社区 谨上。</p>';
